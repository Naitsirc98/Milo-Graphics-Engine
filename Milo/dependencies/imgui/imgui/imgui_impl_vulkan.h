...
IMGUI_IMPL_API ImTextureID    ImGui_ImplVulkan_AddTexture(uint32_t textureId, VkSampler sampler, VkImageView image_view, VkImageLayout image_layout);
...
IMGUI_IMPL_API void	    ImGui_ImplVulkan_DeleteTexture(uint32_t textureId);
