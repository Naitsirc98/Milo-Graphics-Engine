...
namespace milo {
	...
	const int32 NUMBER_OF_KEYS = static_cast<int32>(Key::Key_Last);
	...
	private:
		Keyboard() {
			memset(keys, static_cast<int32_t>(KeyAction::Release), NUMBER_OF_KEYS * sizeof(KeyAction));
			activeModifiers = 0;
		}
	};
