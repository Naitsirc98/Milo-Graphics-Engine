...
namespace milo {
	...
	VulkanBRDFPass::VulkanBRDFPass(VulkanDevice* device) : m_Device(device) {
	...
	void VulkanBRDFPass::execute(const VulkanSkyboxPassExecuteInfo& execInfo) {
	...
	void VulkanBRDFPass::updateDescriptorSet(const VulkanSkyboxPassExecuteInfo& execInfo) {
	...
	void VulkanBRDFPass::createDescriptorSetLayout() {
	...
	void VulkanBRDFPass::createDescriptorPool() {
	...
	void VulkanBRDFPass::createPipelineLayout() {
	...
	void VulkanBRDFPass::createComputePipeline() {
